...
Colorrules={
  DeltaC[Index[Colour,iii_],Index[Colour,iii_]]->3,
  DeltaC[Index[Gluon,iii_],Index[Gluon,iii_]]->8,
  DeltaC[Index[type_,iii_],Index[type_,jj_]]DeltaC[Index[type_,jj_],Index[type_,kkk_]]->DeltaC[Index[type,iii],Index[type,kkk]], 
  DeltaC[Index[type_,iii_],Index[type_,jj_]]DeltaC[Index[type_,jj_],Index[type_,iii_]]->DeltaC[Index[type,iii],Index[type,iii]], 
  T[aa_,iii_,iii_]->0,
...
Lorentzrules={
  ...
  Eps[i1_,i2_,i3_,i4_]Eps[j1_,j2_,j3_,j4_] :> -(ME[i1, j4]*ME[i2, j3]*ME[i3, j2]*ME[i4, j1] - 
