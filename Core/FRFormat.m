...
Format[CC[t_][ind___], TraditionalForm] := Superscript[Subscript[t, ind], C];
...
Format[FR$deltaZ[args1__][$aa__]] := Superscript[FR$deltaZ[args1],List[$aa]];
Format[FR$delta[args1__][$aa__]] := Superscript[FR$delta[args1],List[$aa]];
