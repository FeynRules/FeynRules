...
RunningParameter::usage="Indicates wheter a parameter should run";

GaugeField::usage="Tag a field as a gauge field"

PyrateTag::usage="Tags a gauge group in the Pyr@te gauge group classification system";

PyrateRep::usage="Taga a representation matrix in the Pyr@te representation matrix system";

WritePyrateOutput::usage="Main Pyrate interface method";

$PyrateInferfaceDebug::usage = "Debug flag";
