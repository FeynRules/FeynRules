...
CreateCouplingObjectEntry[object_UVLoopCouplingObject] := CreateCouplingObjectEntry[CouplingObject @@ object];


CreateCouplingObjectEntry[object_UVCouplingObject] := CreateCouplingObjectEntry[CouplingObject @@ object, True];


CreateCTCouplingObjectEntry[object_UVCouplingObject] := CreateCouplingObjectEntry[CouplingObject @@ object];
CreateCTCouplingObjectEntry[object_UVLoopCouplingObject] := CreateCouplingObjectEntry[CouplingObject @@ object];
CreateCTCouplingObjectEntry[object_R2CouplingObject] := CreateCouplingObjectEntry[CouplingObject @@ object];
...
LaurentSeriesCoefficientExtractor[pow_,  FR$Eps^n_] := LaurentSeriesCoefficientExtractor[pow FR$Eps^n, 1];
