...
SameLorentzQ[l1_,l2_]:=MatchQ[l1/.{L$Ga->Ga,L$ProjM->ProjM,L$ProjP->ProjP,L$SlashedP->SlashedP},
  l2/.{L$Ga->Ga,L$ProjM->ProjM,L$ProjP->ProjP,L$SlashedP->SlashedP,L$Eps[aa_,b__] L$FV[x_,aa_]->L$Eps[L$FV[x],b]}/. Index[y_,x_?(FreeQ[#1,Ext]&)]->Condition[PatternX[x,_],Depth[x]<2]/. PatternX->Pattern]
