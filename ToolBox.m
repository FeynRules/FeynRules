...
CheckHermiticity[lagrangian_, options___] := Block[{tempoptions, results, llag, hcllag},
     ...
     llag = OptimizeIndex[ExpandIndices[lagrangian]]/.{Eps[argx__] :> Signature[{argx} ] Eps[Sequence @@ Sort[{argx}]]};  (* CD: Added ExpandIndices *)
     hcllag = OptimizeIndex[ExpandIndices[HC[lagrangian]]]/.{Eps[argx__] :> Signature[{argx} ] Eps[Sequence @@ Sort[{argx}]]};
